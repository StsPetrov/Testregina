...
* Changed animation condition in customizer.
...
* Added go pro button in player and footer settings in customizer.
...
* Added featured image border radius in customizer.
...
* Added copyright font weight option in customizer.
* Added show/ hide slider arrow option in customizer.
* Added slider next/prev icon change option in customizer.
* Update pot file.

= 0.5.6 =
* Resolved css error of single post sidebar in responsive media.
* Resolved customizer error.
* Resolved pro in premium settings css.
...
= 0.6.5 =
* Resolved mobile player icons in responsive media.
* Resolved block pattern frontend css error in responsive media.

= 0.6.6 =
* Added grid post button text option in grid layout setting.
* Added grid post excerpt suffix option in grid layout setting.
* Added grid post content option in grid layout setting.
* Added cart page css.
* Changed rtl css.
* Update pot file. 
...
* Resolved topbar menu css issue.
...
* Added show / hide topbar option in responsive media.
* Resolved css error for footer calender.
* Resolved error for copyright alignment.
* Resolved css error for bredcrumbs in responsive media.
* Tested upto WP v6.6.
* Updated pot file.
...
* Resolved single post image error.
* Updated pot file.
...
= 0.8.1 =
* Resolved breadcrumb name issue.
* Resolved ibtana ativation redirection issue.
* Added theme bundle tab in activation notice.
...
= 1.0.5 =
* Added progress bar setting in customizer.
...
Audio Podcast WordPress Theme, Copyright 2021 VWThemes
Audio Podcast is distributed under the terms of the GNU GPL.
...
== Fonts ==
* Work+Sans *
* Source : https://fonts.google.com/specimen/Work+Sans?query=Work+Sans
...
Slider Image,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/89799

Audio Image,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/489751

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-audio-podcast/