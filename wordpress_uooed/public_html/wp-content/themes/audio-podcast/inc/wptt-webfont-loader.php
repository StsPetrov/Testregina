...
if ( ! class_exists( 'Audio_Podcast_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Audio_Podcast_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'audio_podcast_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function audio_podcast_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Audio_Podcast_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'audio_podcast_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function audio_podcast_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Audio_Podcast_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
